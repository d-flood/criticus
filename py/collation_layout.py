from tkinter import (Button, messagebox, ttk, Grid, Label, LabelFrame, Frame,
                     BOTH, Entry, Scrollbar, Listbox, LEFT, RIGHT, EXTENDED,
                     N, S, E, W, NS, EW, Y, END)
import re
import io
import os
...
class Collation:
    def __init__(self, collation_tab, main_dir, root, my_os):
        ...
        self.listbox_frame.grid(row=0, rowspan=5, column=1, sticky=NS,
                                padx=20)
        self.wit_listbox = Listbox(
            self.listbox_frame, width=30, selectmode=EXTENDED)
